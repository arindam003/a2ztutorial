            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3>Tutor Google Login Management
                        ...
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <a class="edit_data" href="<?php echo base_url();?>tutorgoogle/view/<?php echo $all->id;?>"><i class="fas fa-eye"></i></a>
                                       &nbsp;
...
<script type="text/javascript">
  function myJsFunc_comdel(dataid,dataimg)
  {
    ...
    {
    window.location.href = "<?php echo base_url()?>tutorgoogle/delete_data/"+dataid+'/'+dataimg;
    }
  }
</script>      