            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3>Tutor Google Login Details Management
                    ...
                    <div class="alert alert-danger">
                      ...
                      <?php } ?>
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                <div class="btn-group">
                                   <a id="editable-sample_new" class="btn btn-primary" href="<?php echo base_url('tutorgoogle')?>">
                                       Back 
                                    </a>
                                </div>
                            ...
                            <div class="container" style="padding-left: 10%;">
                              <?php 
                                ...
                                foreach($tutorgoogle_view as $view) { ?>
