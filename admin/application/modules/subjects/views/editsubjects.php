  ...
  <?php } ?>
                    <section class="panel">
                        <header class="panel-heading">
                           <h3> Edit Subjects <a href="<?php echo base_url('subjects');?>" class="btn btn-danger flotright">Back</a></h3>
                        </header>
                        <div class="panel-body">
                            ...
                            <form role="form" method="POST" action="" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="subject_slugname" value="<?php echo $single->subject_slugname;?>" type="text" class="form-control" id="inputslidercaption">
                                </div>
