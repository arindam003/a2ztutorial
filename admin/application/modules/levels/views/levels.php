                    ...
                    <div class="alert alert-danger">
                      ...
                      <?php } ?>
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                <div class="btn-group">
                                   <a id="editable-sample_new" class="btn btn-primary" href="<?php echo base_url()?>levels/add">
                            ...
                            <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
                                ...
                                <tr class="">
                                    ...
                                    <a href="<?php echo base_url();?>levels/status_active/<?php echo $all->id;?>" class="btn btn-success">Active </a>
                                     <?php } else if($all->status=="1"){?>
                                       <a href="<?php echo base_url();?>levels/status_inactive/<?php echo $all->id;?>" class="btn btn-danger">Inactive</a>
                                     <?php } 
                                    ?></td>
