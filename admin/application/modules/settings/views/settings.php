...
&nbsp;
 ...
 <?php foreach($all_data as $resdata){?>
 <div class="col-lg-6">
   <h3>Address Management</h3>
               ...
               <div class="form-group">
                    ...
                    <label>Email:</label><br />
                           ...
                           <label>Logo:</label><br />
                             <img  src="<?php echo base_url()?>uploads/settings_image/<?php echo $resdata->logo?>" height=100px;width=100px;>
                           </div>
                           <div class="form-group">

                           <label>Fav Icon:</label><br />
                             <img  src="<?php echo base_url()?>uploads/settings_image/<?php echo $resdata->fav_icon?>" height=100px;width=100px;>
                           </div>
                           </div>
                 ...
                 <?php } ?> 
                   <div class="col-lg-12">
                          ...
                          <a href="<?php echo base_url();?>settings/edit/1" class="btn btn-success">Edit Settings</a>
