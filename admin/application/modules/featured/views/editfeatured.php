  ...
  <?php } ?>
                    <section class="panel">
                        <header class="panel-heading">
                           <h3> Edit featured <a href="<?php echo base_url('featured');?>" class="btn btn-danger flotright">Back</a></h3>
                        </header>
                        <div class="panel-body">
                            ...
                            <form role="form" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                <img src="<?php echo base_url()?>uploads/featured_image/<?php echo $single->image_src;?>" height=100px; width=100px;>
