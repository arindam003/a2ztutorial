                    ...
                    <div class="alert alert-danger">
                      ...
                      <?php } ?>
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                <div class="btn-group">
                                   <a id="editable-sample_new" class="btn btn-primary" href="<?php echo base_url('parentlist/add')?>">
                            ...
                            <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                      <a class="edit_data" href="<?php echo base_url();?>parentlist/edit/<?php echo $all->id;?>"><i class="fa fa-edit"></i></a> &nbsp;
...
<script type="text/javascript">
  function myJsFunc_comdel(dataid,dataimg)
  {
    ...
    {
    window.location.href = "<?php echo base_url()?>parentlist/delete_data/"+dataid+'/'+dataimg;
    }
  }
</script>      