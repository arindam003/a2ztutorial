            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3>Student Google Login Details Management
                    ...
                    <div class="alert alert-danger">
                      ...
                      <?php } ?>
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                <div class="btn-group">
                                   <a id="editable-sample_new" class="btn btn-primary" href="<?php echo base_url('studentgoogle')?>">
                                       Back 
                                    </a>
                                </div>
                            ...
                            <div class="container" style="padding-left: 10%;">
                              <?php 
                                ...
                                foreach($studentgoogle_view as $view) { ?>
                                ...
                                <!-- <img  src="<?php //echo base_url()?>uploads/featured_image/<?//=$all->image_src?>" height=100px;width=100px;> -->
