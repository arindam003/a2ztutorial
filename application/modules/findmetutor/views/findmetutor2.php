                    ...
                    <form method="POST">
                        ...
                        <div class="goal">
                            ...
                            <div class="f-wrap" id="goal">
                                ...
                                <label class="radio">
                                    <input name="goal" type="radio" value="<?php echo $goal->go_id ;?>">
                        ...
                        <div class="lessons">
                            ...
                            <div class="f-wrap" id="lessons">
                                ...
                                <label class="radio">
                                    <input name="lesson" type="radio" value="<?php echo $lessons->less_id ;?>">
                            ...
                            <div class="f-wrap" id="price">
                                ...
                                <?php 
                                    if($spend->starting_price == '' && $spend->ending_price == ''){ ?>
                                        <input name="price" type="radio" value="<?php echo $spend->sp_id ;?>"><?php echo $spend->sp_titile ;?>
                                <?php    }else{ ?>
                                    <input name="price" type="radio" value="<?php echo $spend->sp_id ;?>">
