            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                    ...
                    <h5>Our team is on standby and ready to help! Our tailored matching service is free and easy-to-use,
                        with no obligations.</h5>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    <!-- <img src="images/find-me.png" width="100%" /> -->
                ...
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                    ...
                    <form method="POST">
                        <div class="az-searchbar">
                            ...
                            <select class="form-control" id="select2-single-box searchbar" name="subjects"
                                ...
                                <optgroup label="Popular Subjects">
                                    ...
                                    <option value="<?php echo $popularsubject->id ;?>"><?php echo $popularsubject->name ;?></option>
                        ...
                        <div class="goal">
                            ...
                            <div class="f-wrap" id="goal">
                                <label class="radio">
                                    <input name="goal" type="radio" value="Improve Grades">
                                    Improve Grades
                                </label>
                                <label class="radio">
                                    <input name="goal" type="radio" value="Boost Confidence">
                                    Boost Confidence
                                </label>
                                <label class="radio">
                                    <input name="goal" type="radio" value="Prep for Exams">
                                    Prep for Exams
                                </label>
                                <label class="radio">
                                    <input name="goal" type="radio" value="Fill In Subject Gap">
                                    Fill In Subject Gap
                                </label>
                            </div>
                        </div>
                        <div class="lessons">
                            ...
                            <div class="f-wrap" id="lessons">
                                <label class="radio">
                                    <input name="lesson" type="radio" value="Once A Week">
                                    Once A Week
                                </label>
                                <label class="radio">
                                    <input name="lesson" type="radio" value="Twice A Week">
                                    Twice A Week
                                </label>
                                <label class="radio">
                                    <input name="lesson" type="radio" value="Fortnightly">
                                    Fortnightly
                                </label>
                                <label class="radio">
                                    <input name="lesson" type="radio" value="I'll Decide Later">
                                    I'll Decide Later
                                </label>
                            </div>
                        </div>
                        <div class="price">
                            ...
                            <div class="f-wrap" id="price">
                                <label class="radio">
                                    <input name="price" type="radio" value="£18 - £20">
                                    £18 - £20
                                </label>
                                <label class="radio">
                                    <input name="price" type="radio" value="£21 - £25">
                                    £21 - £25
                                </label>
                                <label class="radio">
                                    <input name="price" type="radio" value="£26 - £43">
                                    £26 - £43
                                </label>
                                <label class="radio">
                                    <input name="price" type="radio" value="I Do Not Mind">
                                    I Do Not Mind
                                </label>
                            </div>
                        </div>
                        <div class="datetime">
                            ...
                            <div class="date-wrap" id="datetime">
                                <div class="date">
                                    ...
                                    <input name="datetime" type="date" id="date">
                                </div>
                                <div class="time">
                                    <label>PICK A TIME (UK TIME)</label>
                                    <input name="datetime" type="time" id="time">
                                </div>
                            </div>
                        </div>
