<?php
 ...
 //        //echo $this->db->last_query(); die; //google_login
 ...
 //    function get_googleprofile(){
	...
	function mail_check($email){
	    ...
	    $this->db->where('usertype_id','1');
	    $query = $this->db->get('tbl_signup');  //echo $this->db->last_query(); die;
	   //if($usertype_id == '1'){
			$result = $query->result();
			return $result;
		//}
