                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                       <img  src="<?php echo base_url()?>admin/uploads/student_image/<?php echo $single->image_src;?>" width="100" height="100">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name ="university" class="form-control" value="<?php echo $single->university;?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        <button class="save-changes-button"><a  href="<?php echo base_url();?>students/<?php echo $profile->id;?>">Back</a></button>
                                    </div>
                                </div>
                            </div>
                        </form>
