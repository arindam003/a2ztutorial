<?php
    ...
    public function google(){
        ...
        if ($gClient->getAccessToken()) {
            ...
            $google_datafetch = $this->Students_model->mail_check($email);

       if($google_datafetch){
               $google_insert = $this->Students_model->add_data($user_information);
    ...
    //         // echo '<pre>';
    //         //    print_r($student_id); die;
    //          $signupprofile = $this->Students_model->get_signup_profile($googlemail);
