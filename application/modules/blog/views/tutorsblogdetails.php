...
<section class="az-contact-body">
  ...
  <div class="container">
    ...
    <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 col-12"></div>
      ...
      <div class="blog-details">
        <?php //echo '<pre>';
        //print_r($parents_blogdetails);die; 
        foreach($tutors_blogdetails as $blogdetails){?>
      <div class="breadcrumbs">
        <a href="<?php echo base_url('blog');?>">a2ztutorials Blog</a> / <a href="<?php echo base_url('blog/tutors');?>">For Tutors</a>
    </div>
       <img src="<?php echo base_url();?>admin/uploads/blog_image/<?php echo $blogdetails->blog_image_src_1; ?>"/>
       <div class="category">a2ztutorials for Tutors</div>
  ...
  <h2>1. <?php echo $blogdetails->heading_2; ?></h2>
    ...
    <div class="row">
      <?php
        foreach($tutors_blogdetails as $articles){
