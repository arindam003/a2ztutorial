    ...
    <section class="wrapper">
        ...
        <section class="panel">
            <header class="panel-heading">
               <h3> Edit Student <a href="<?php echo base_url('student');?>" class="btn btn-danger flotright">Back</a></h3>
            </header>
                ...
                <form role="form" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="formhold row">
                        ...
                        <p>
                            ...
                            <img src="<?php echo base_url()?>uploads/student_image/<?php echo $single->image_src;?>" height=100px; width=100px;>
                     ...
                     <!-- <div class="formhold row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <input type="number" class="form-control" name="password" value="<?php echo $single->password;?>">
                            </div>
                        </div> -->
                    <div class="formhold row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
