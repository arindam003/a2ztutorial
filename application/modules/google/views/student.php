                        ...
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                      <a class="edit_data" href="<?php echo base_url();?>student/edit/<?php echo $all->id;?>"><i class="fa fa-edit"></i></a> &nbsp;
...
<script type="text/javascript">
  function myJsFunc_comdel(dataid,dataimg)
  {
    ...
    {
    window.location.href = "<?php echo base_url()?>student/delete_data/"+dataid+'/'+dataimg;
    }
  }
</script>      