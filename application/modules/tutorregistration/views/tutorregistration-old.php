                    ...
                    <form id="form-id" class ="myform" method="POST">
                        ...
                        <div >
                         <h2 class='heading-title'>ACCOUNT INFORMATION</h2>
                           ...
                           <!-- <a href="#" class='next-button custom-button' id="nextBtn-1">Next</a> -->
                            </div> 
                        </fieldset>
                        ...
                        <fieldset id="third-form">
                            ...
                            <!-- <input type='button' name='prev' id="prevBtn" onclick="nextPrev(-1)" class='prev-button custom-button' value="Back"> -->
       ...
       $('#nextBtn-1').click(function(){
        ...
        $('#nextBtn-2').click(function(){
            if($('#title').val() == '' ){
                ...
                $('#address2-error').html('Address2 is required !');
                return false;
            }
            else if($('#town').val() == '' ){
        ...
        $('#signup').click(function(){
            ...
            else if($('#experience').val() == '' ){  /* ($('#experience').val() == '' )*/
