...
if(!defined('BASEPATH')) { exit('No direct script access allowed'); }
    ...
    public function index(){
        ...
        if($this->session->userdata('googlelogin_id')){
         $googleloginid = $this->session->userdata('googlelogin_id');
         $data['signupprofile'] = $this->Students_model->get_googleloginid($googleloginid);
        }
        ...
        //     $oauthid = $this->session->userdata('oauth_uid');
        //     echo $oauthid;die;
        //     $data['signupprofile'] = $this->Students_model->get_gsignprofile($oauthid);
        // }
        
           

        //    $googleloginstudent = get_googleloginstudent();
        //    $googleid = $googleloginstudent[0]->id;
        //    $googleemail = $googleloginstudent[0]->email;


        // if($googleloginstudent){
            
        //     $data['signupprofile'] = $this->Students_model->get_signup_profile($googleid,$googleemail);
        // }
            
            

            // echo '<pre>';
            // print_r($googlestudentid); die;
        ...
        $google_insert = $this->Students_model->insert_googleuser($user_information);
           ...
           if($google_datafetch){
                    $user_signup = array(
                     ...
                     $this->session->set_userdata($user_signup);
                     $signupoauthid = $this->session->userdata('googlelogin_id');
                     //echo $signupoauthid;die;
