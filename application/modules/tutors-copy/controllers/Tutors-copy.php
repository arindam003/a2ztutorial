<?php
    ...
    public function signup(){
        if($this->input->server('REQUEST_METHOD') == 'POST'){
                ...
                $this->form_validation->set_rules('file_src', 'CV Upload', 'required');
               ...
               $tutor = $this->Tutors_model->get_checking($data['email']);
                ...
                if($this->form_validation->run()== TRUE){
                        ...
                        if (! $this->upload->do_upload()) {
                         ...
                         // redirect('tutorsignup/signup');
                         //$this->load->view('tutorsignup', $error);
    ...
    public function google(){
        ...
        // old
        $clientId = '248055939114-e5rdj5psf3mt9u0bl9939cjt9r4oqkl4.apps.googleusercontent.com'; 
        $clientSecret = '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';
        $redirectURL = 'https://seller007.co.uk/dev/A2ZTutorials/tutors/google';
       ...
       //if($user_information){
               $google_insert = $this->Tutors_model->insert_user($user_information);
               if($google_insert){
                $google_datafetch = $this->Tutors_model->get_googleprofile();
                ...
                echo '<h3><a href="https://seller007.co.uk/dev/A2ZTutorials/tutors/googlelogout">Logout</a></h3>';
                echo '</div>';
