...
<?php 
 if($this->session->flashdata('success_msg')!="") {
    // echo "<script type='text/javascript'>alert($this->session->flashdata('success_msg'));</script>";
    echo "<script type='text/javascript'>alert('Thank You ! We will get back soon');</script>";
}

if($this->session->flashdata('err_msg')!="") {
    echo "<script type='text/javascript'>alert('Something Wrong! Please Login First');</script>";
}?>
                        <div class="row">
