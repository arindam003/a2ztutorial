...
<!--  subjects input wise teacher (old)-->
      <!-- <div class="az-searchbar" >
            <input type="text" id="subjects" name="subjects" placeholder="Subject..">
            <button type="button" name ="search" id="search" value="">FIND A TUTOR</button>
        </div> -->
                                ...
                                <div class="carousel-cont">
                                    <div class="testi-cont1">
                                        <div class="testi-img-cont">
                                            <img src="<?php echo base_url();?>admin/uploads/testimonials_image/<?php echo $testimonials->image_src; ?>" alt ="test2.jpg"/>
                                        </div>
...
<!-- ########### subjects wise teacher searching home page (new-new url changes ) ###### -->
...
<!--################# subjects wise teacher searching home page  #####################-->
