...
class Profile extends MX_Controller{
    ...
    public function index(){
        ...
        if($this->input->server('REQUEST_METHOD') == 'POST'){ 
            $this->form_validation->set_rules('message', 'message', 'trim|required');
                ...
                // $datasuccess = 'Thank You ! We will get back soon';
                // $datasuc['success'] = json_encode($datasuccess);
        ...
        if($this->session->userdata('parent_id')){ 
                ...
                $datasuccess = 'Thank You ! We will get back soon';
                $datasuc['success'] = json_encode($datasuccess);
                //$this->load->view('profile',$datasuc);

                //$datasuc['json'] = json_encode($datasuccess['success']);
             ...
             // $dataerror = 'Please Login First';
             // $dataerr['error'] = json_encode($dataerror); 
             // print_r($data['error']);die;
             //$this->load->view('profile',$dataerr);



             //$dataerr['json'] = json_encode($dataerror['error']);
   ...
   //  public function successmessagedatapass(){
   //      $success = array(
   //          "successmessage" => "Thank You ! We will get back soon."
   //      );

   //  $data['json'] = $success;
   //  }

   //  public function errormessagedatapass(){
   //      $error = array(
   //          "errormessage" => "Please Login First"
   //      );

   // echo  $data['json'] = $error;
   //  }
