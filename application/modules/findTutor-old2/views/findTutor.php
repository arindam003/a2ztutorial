 ...
 <section class="az-fat-banner">
    ...
    <section class="az-fat-tutors" id="findtutor-sec">
        <div class="container">
            ...
            <div class="row" >
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12" id="findtutorSec">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var checkbox_timing =  $('input[name="time"]:checked').val() ;
        var selectdays =  $('input[name="days"]:checked').val() ;
