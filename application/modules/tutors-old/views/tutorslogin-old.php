<section class="login-register-bg">
  <div class="container">
    ...
    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12"></div>
      ...
      <div class="new-login-d">
        <div class="u-hide--small"><img src="<?php echo base_url()?>themes/front/images/login3.png" alt="Tutor" height="143" width="165">
              <h2>I am a Tutors</h2>
  ...
  <form id="form" name="form" method="post" enctype="application/x-www-form-urlencoded" data-partialsubmit="true">
              <p>
                ...
                <input type="email" name="uni_emaildomain"  class="validate[required,custom[email]] feedback-input" pattern="^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$" placeholder="Email">
                <small style="color:red;"><?php echo form_error('uni_emaildomain');?></small>
            </p>
                <p>
