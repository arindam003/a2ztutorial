...
<!-- <div class="formhold row " > -->
    <div id="firstsubjectlev">
        <div class="subjectleveldiv">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <!-- <div class="form-check form-check-inline " id="check_blog"> -->
                        <div class="form-check chk" id="check_level">
                        <?php  foreach($levels_data as $lev){  ?>
                           
                       <input class="form-check-input" type="checkbox" value="<?=$lev->id?>" name="levels_id[]" >
                                <label class="checkbox-inline" for="flexCheckDefault">&nbsp;&nbsp;&nbsp;<?=$lev->name?>
                               </label>
               ...
               <!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <label>Levels  <span>*</span></label>
                     <select name="levels_id[]" class="form-control" id="levels">
    ...
    <div id="moresubjectlev"></div>  
    <div>
        <button type="button" class="btn btn-info" onclick="addsublev()">Add</button>
        <button type="button" class="btn btn-danger" onclick="removesublev()">Remove</button>
    </div>
...
<script type="text/javascript">
  function addsublev(){
   ...
   // $('#firstsubjectlev .subjectleveldiv').clone().find('select').val('').end().appendTo('#moresubjectlev');

    // $('#firstsubjectlev .subjectleveldiv').clone().appendTo('#moresubjectlev');
     // $('#firstproduct .subjectleveldiv').clone().find('input').val('').end().find('textarea').val('').end().appendTo('#moreproduct');
 }
