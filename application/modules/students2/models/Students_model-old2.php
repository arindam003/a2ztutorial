<?php
 ...
 function get_googleprofile(){
	...
	function add_data($data){
		...
		function get_googleloginid($googleloginid){
			$this->db->select('*');
			$this->db->where('googlelogin_id',$googleloginid);
			//$this->db->where('category','Student');
			$query = $this->db->get('tbl_signup');
			$result = $query->result();
			 return $result;
		}
		// function get_gsignprofile($oauthid){
		// 	$this->db->select('*');
		// 	$this->db->where('googlelogin_id',$oauthid);
		// 	//$this->db->where('category','Student');
		// 	$query = $this->db->get('tbl_signup');
		// 	$result = $query->result();
		// 	 return $result;
